...
#                script (type 'codesign_vivado_bd.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/Vick/Desktop/codesign/codesign_vivado/codesign_vivado.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
