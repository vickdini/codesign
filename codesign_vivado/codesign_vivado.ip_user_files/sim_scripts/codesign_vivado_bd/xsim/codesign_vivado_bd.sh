...
#
# Script generated by Vivado on Wed Jun 25 08:11:12 +0200 2025
# SW Build 6140274 on Thu May 22 00:12:29 MDT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : codesign_vivado_bd.sh
...
#
# Usage        : codesign_vivado_bd.sh
#                codesign_vivado_bd.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                codesign_vivado_bd.sh [-reset_run]
#                codesign_vivado_bd.sh [-reset_log]
#                codesign_vivado_bd.sh [-help]
#
...
# script info
echo -e "codesign_vivado_bd.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./codesign_vivado_bd.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_21 -L zynq_ultra_ps_e_vip_v1_0_21 -L xlconstant_v1_1_10 -L proc_sys_reset_v5_0_17 -L smartconnect_v1_0 -L axi_register_slice_v2_1_35 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot codesign_vivado_bd xil_defaultlib.codesign_vivado_bd xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim codesign_vivado_bd -key {Behavioral:sim_1:Functional:codesign_vivado_bd} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_fac1.protoinst" -protoinst "protoinst_files/codesign_vivado_bd.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb codesign_vivado_bd.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./codesign_vivado_bd.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: codesign_vivado_bd.sh [-help]\n\
Usage: codesign_vivado_bd.sh [-step]\n\
Usage: codesign_vivado_bd.sh [-lib_map_path]\n\
Usage: codesign_vivado_bd.sh [-reset_run]\n\
Usage: codesign_vivado_bd.sh [-reset_log]\n\
Usage: codesign_vivado_bd.sh [-keep_index]\n\
Usage: codesign_vivado_bd.sh [-noclean_files]\n\n\
