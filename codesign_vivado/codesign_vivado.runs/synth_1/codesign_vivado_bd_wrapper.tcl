...
synth_design -top codesign_vivado_bd_wrapper -part xczu3eg-sfvc784-2-e
...
write_checkpoint -force -noxdef codesign_vivado_bd_wrapper.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
generate_parallel_reports -reports { "report_utilization -file codesign_vivado_bd_wrapper_utilization_synth.rpt -pb codesign_vivado_bd_wrapper_utilization_synth.pb"  } 
