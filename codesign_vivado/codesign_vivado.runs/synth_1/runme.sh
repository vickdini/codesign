...
HD_PWD='C:/Users/Vick/Desktop/codesign/codesign_vivado/codesign_vivado.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log codesign_vivado_bd_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source codesign_vivado_bd_wrapper.tcl
