...
EAStep vivado -log codesign_vivado_bd_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source codesign_vivado_bd_wrapper.tcl -notrace
