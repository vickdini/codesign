...
/*##################################################################### */
    ...
    * rt Databus)
    *  PSU_IOU_SLCR_MIO_PIN_34_L3_SEL                              2

    * Configures MIO Pin 34 peripheral interface mapping
    * (OFFSET, MASK, VALUE)      (0XFF180088, 0x000000FEU ,0x00000040U)
    */
	PSU_Mask_Write(IOU_SLCR_MIO_PIN_34_OFFSET, 0x000000FEU, 0x00000040U);
/*##################################################################### */
    ...
    * rt Databus)
    *  PSU_IOU_SLCR_MIO_PIN_35_L3_SEL                              2

    * Configures MIO Pin 35 peripheral interface mapping
    * (OFFSET, MASK, VALUE)      (0XFF18008C, 0x000000FEU ,0x00000040U)
    */
	PSU_Mask_Write(IOU_SLCR_MIO_PIN_35_OFFSET, 0x000000FEU, 0x00000040U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180204, 0xFFFFFFFFU ,0x51000000U)
    */
	PSU_Mask_Write(IOU_SLCR_MIO_MST_TRI0_OFFSET,
		0xFFFFFFFFU, 0x51000000U);
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180208, 0xFFFFFFFFU ,0x00B00002U)
    */
	PSU_Mask_Write(IOU_SLCR_MIO_MST_TRI1_OFFSET,
		0xFFFFFFFFU, 0x00B00002U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * Each bit applies to a single IO. Bit 0 for MIO[26].
    *  PSU_IOU_SLCR_BANK1_CTRL0_DRIVE0_BIT_5                       0
    ...
    * Each bit applies to a single IO. Bit 0 for MIO[26].
    *  PSU_IOU_SLCR_BANK1_CTRL0_DRIVE0_BIT_19                      0
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180154, 0x03FFFFFFU ,0x03F7FFD7U)
    */
	PSU_Mask_Write(IOU_SLCR_BANK1_CTRL0_OFFSET,
		0x03FFFFFFU, 0x03F7FFD7U);
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180158, 0x03FFFFFFU ,0x03F7FFD7U)
    */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180160, 0x03F7FFC3U ,0x03F7FFC3U)
    */
	PSU_Mask_Write(IOU_SLCR_BANK1_CTRL4_OFFSET,
		0x03F7FFC3U, 0x03F7FFC3U);
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180164, 0x03FFFFFFU ,0x03F0FF7FU)
    */
	PSU_Mask_Write(IOU_SLCR_BANK1_CTRL5_OFFSET,
		0x03FFFFFFU, 0x03F0FF7FU);
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180168, 0x03FFFFFFU ,0x00000028U)
    */
	PSU_Mask_Write(IOU_SLCR_BANK1_CTRL6_OFFSET,
		0x03FFFFFFU, 0x00000028U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    *  PSU_GPIO_DIRM_2_DIRECTION_2                                 0x1000000

    * Direction mode (GPIO Bank2, MIO)
    * (OFFSET, MASK, VALUE)      (0XFF0A0284, 0x03FFFFFFU ,0x01000000U)
    */
	PSU_Mask_Write(GPIO_DIRM_2_OFFSET, 0x03FFFFFFU, 0x01000000U);
/*##################################################################### */
    ...
    *  PSU_GPIO_OEN_2_OP_ENABLE_2                                  0x1000000

    * Output enable (GPIO Bank2, MIO)
    * (OFFSET, MASK, VALUE)      (0XFF0A0288, 0x03FFFFFFU ,0x01000000U)
    */
	PSU_Mask_Write(GPIO_OEN_2_OFFSET, 0x03FFFFFFU, 0x01000000U);
/*##################################################################### */
